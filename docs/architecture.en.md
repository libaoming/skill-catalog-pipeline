...
For the three field conventions across fetch → normalize → load, see [field-dictionary.en.md](field-dictionary.en.md).

## Appendix: Engineering Crystallizations

For the retrospective compiling every pitfall hit across the whole pipeline, see [engineering-notes.en.md](engineering-notes.en.md) — the highest-value part of this plan.
